                ...
                <table className="w-full caption-bottom text-sm border-separate data-table" style={{ borderSpacing: 0 }}>
                  <TableHeader className="sticky top-0 z-20 bg-[#f5f6f8] [&_tr]:border-b [&_tr]:border-slate-200">
                    <TableRow>
                      ...
                      {col('seasons') && <TableHead className="min-w-[116px] w-[116px] text-center text-[13px] font-semibold tracking-wide text-slate-500">{columnLabel('seasons')}</TableHead>}
                      {col('attendance') && <TableHead className="w-24 text-center text-[13px] font-semibold tracking-wide text-slate-500">{columnLabel('attendance')}</TableHead>}
